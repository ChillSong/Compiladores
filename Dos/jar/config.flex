...
{COMA} {
    Tokens tok=new Tokens(yytext(),Sym.COMA,yyline,yycolumn);
    this.hayToken=true;
    return tok;
}
{IGUAL} {
...
{CIRCUNFLEJO} {
     Tokens tok=new Tokens(yytext(),Sym.CIRCUNFLEJO,yyline,yycolumn);
     this.hayToken=true;
     return tok;
}
{P_APERTURA} {
...
{PI} {
    Tokens tok=new Tokens(yytext(),Sym.PI,yyline,yycolumn);
    this.hayToken=true;
    return tok;
}
{MIN} {
    Tokens tok=new Tokens(yytext(),Sym.MIN,yyline,yycolumn);
    this.hayToken=true;
    return tok;
}
{MAX} {
    Tokens tok=new Tokens(yytext(),Sym.MAX,yyline,yycolumn);
    this.hayToken=true;
    return tok;
}
{LOG} {
    Tokens tok=new Tokens(yytext(),Sym.LOG,yyline,yycolumn);
    this.hayToken=true;
    return tok;
}
{SQR} {
    Tokens tok=new Tokens(yytext(),Sym.SQR,yyline,yycolumn);
    this.hayToken=true;
    return tok;
}
{RESERVADAS} {
